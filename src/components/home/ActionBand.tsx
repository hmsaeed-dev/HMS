...
export default function ActionBand({
  ...
  return (
    <section className="w-full bg-canvas-dark text-canvas-base py-16 sm:py-24 lg:py-32 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-2xl space-y-6 sm:space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            ...
            >
              <div className="font-sans text-[10px] uppercase tracking-wider text-canvas-paper/60 mb-1 flex items-center justify-between">
