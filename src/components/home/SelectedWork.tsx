...
export default function SelectedWork() {
	...
	return (
		<section
			id="selected-work"
			className="w-full bg-surface-canvas py-20 sm:py-28 lg:py-32"
		>
				...
				<div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
					<div className="space-y-2 max-w-xl">
						...
						<p className="font-sans text-sm sm:text-base text-ink-secondary leading-relaxed">
							Production web applications, low-level architectures
							in C++, and multimodal AI pipelines.
						</p>
					</div>
					<Link
						href="/work"
							...
							>
								...
								<div className="relative z-10 w-full backdrop-blur-md bg-gradient-to-b from-[rgba(15,23,42,0.78)] via-[rgba(15,23,42,0.92)] to-[rgba(15,23,42,0.98)] p-5 sm:p-6 rounded-b-3xl flex flex-col justify-between space-y-4">
									...
									<div className="pt-1">
										<Link
											href={`/work/${project.slug}`}
											className="w-full inline-flex items-center justify-center gap-2 bg-white text-neutral-900 font-medium py-2.5 px-4 rounded-full hover:bg-accent- active:scale-[0.99] transition-all shadow-md text-xs sm:text-sm font-sans"
										>
